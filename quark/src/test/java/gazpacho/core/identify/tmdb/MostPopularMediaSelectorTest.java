...
public class MostPopularMediaSelectorTest {
    private TmdbMovies tmdbMoviesApi = mock(TmdbMovies.class);

    private TmdbTvSeries tmdbTvSeriesApi = mock(TmdbTvSeries.class);

    private TmdbTvSeasons tmdbTvSeasonsApi = mock(TmdbTvSeasons.class);
