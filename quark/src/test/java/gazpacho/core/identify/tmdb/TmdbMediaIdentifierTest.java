...
public class TmdbMediaIdentifierTest {
    ...
    private TmdbSearcher searcher = mock(TmdbSearcher.class);

    private TmdbMediaSelector mediaSelector = mock(TmdbMediaSelector.class);

    private QueryTokensParser queryTokensParser = mock(QueryTokensParser.class);

    private Movie movie = mock(Movie.class);

    private TvSeries tvSeries = mock(TvSeries.class);
